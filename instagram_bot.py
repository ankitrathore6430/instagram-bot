...
ADMIN_ID = 745211839  # Replace with your actual Telegram user ID
...
async def broadcast(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"Broadcast complete. Failed to send to {len(failed_ids)} users.")
